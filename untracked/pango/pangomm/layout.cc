...
int Layout::get_character_count() const
{
...
float Layout::get_line_spacing() const
{
...
Glib::RefPtr<const LayoutLine> Layout::get_const_line(int line) const
{
  Glib::RefPtr<const LayoutLine> retvalue = Glib::wrap(pango_layout_get_line_readonly(const_cast<PangoLayout*>(gobj()), line));
  if(retvalue)
    retvalue->reference(); //The function does not do a ref for us.
...
{
  return SListHandle_LayoutLine(pango_layout_get_lines(gobj()), Glib::OWNERSHIP_NONE);
}

SListHandle_ConstLayoutLine Layout::get_lines() const
{
  return SListHandle_ConstLayoutLine(pango_layout_get_lines_readonly(const_cast<PangoLayout*>(gobj())), Glib::OWNERSHIP_NONE);
}

SListHandle_ConstLayoutLine Layout::get_const_lines() const
{
  return SListHandle_ConstLayoutLine(pango_layout_get_lines_readonly(const_cast<PangoLayout*>(gobj())), Glib::OWNERSHIP_NONE);
}
