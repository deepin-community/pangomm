...
public:
  ...
  */
   ...
   * 
   * @return A Pango::AttrList or <tt>nullptr</tt>
   * if none was set.
   */
   ...
   * lines. The @a spacing set with this function is only
   ...
   * 
   * If @a factor is non-zero, lines are placed
   * so that
   * 
   ...
   * set_spacing() is ignored.
   * 
   * If @a factor is zero, spacing is applied as
   * before.
   * 
   * @newin{1,44}
   * 
   ...
   * text or properties. No changes should be made to the lines.
   */
  SListHandle_ConstLayoutLine get_const_lines() const;
